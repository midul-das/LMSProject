...
def login(request):
    ...
    payload = {
        ...
        'redirect_uri': 'http://localhost:8000/LMS/TheSeekers/complete/auth0'
    }
    ...
    # print(response.text)
    # print('https://' + settings.AUTH0_DOMAIN + '/authorize')
    # print("jjj")
    # print('https://' + settings.AUTH0_DOMAIN + '/oauth/token')
